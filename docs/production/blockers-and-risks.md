...
| Ledger integrity is not fully production-grade | New immutable minor-unit ledger tables and balancing service exist, but legacy decimal/string financial paths still remain. | Migrate financial state changes to the production ledger and retire unsafe legacy money fields. |
