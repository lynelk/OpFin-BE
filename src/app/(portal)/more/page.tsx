  ...
  return (
    ...
    >
      ...
      <section className="panel">
        ...
        <div className="grid grid-2">
          <JourneyCard title="Connected accounts & ecosystem" description="Link bank or mobile-money accounts, record household and microbusiness context, connect SACCO/VSLA membership, request asset finance, use participatory finance and manage referrals from one workspace." href="/ecosystem" action="Open connected financial life" status="available" />
