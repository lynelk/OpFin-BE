...
export default function MorePage() {
  return (
    <Screen
      title="More"
      description="Manage setup, automation, verification, permissions, protection, account security and financial resilience without crowding the five main journeys."
    >
